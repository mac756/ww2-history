...
import { SwordsIcon, BuildingIcon, MoneyIcon, DocumentIcon } from "@/components/Icons";
...
const timelineEvents = [
  // 1922 - Rise of Fascism
  {
    ...
    category: "political",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Mussolini_e_il_Re.jpg/800px-Mussolini_e_il_Re.jpg",
  },
  ...
  // 1934 - Night of Long Knives
  {
    ...
    category: "political",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Bundesarchiv_Bild_183-71043-0003%2C_Köln%2C_Aufmarsch_der_SA.jpg/800px-Bundesarchiv_Bild_183-71043-0003%2C_Köln%2C_Aufmarsch_der_SA.jpg",
  },
  // 1935 - Italian Invasion of Ethiopia
  {
    ...
    category: "military",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/Italian_invasion_of_Ethiopia.jpg/800px-Italian_invasion_of_Ethiopia.jpg",
  },
  // 1936 - Spanish Civil War
  {
    ...
    category: "military",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Guernica_%28 Picasso%29.jpg/800px-Guernica_%28_Picasso%29.jpg",
  },
  // 1936 - Berlin Olympics
  {
    ...
    category: "political",
    side: "neutral",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Jesse_Owens2.jpg/800px-Jesse_Owens2.jpg",
  },
  // 1936 - Axis Rome-Berlin Pact
  {
    ...
    category: "political",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Bundesarchiv_Bild_183-W0407-300%2C_Henning_von_Tresckow.jpg/800px-Bundesarchiv_Bild_183-W0407-300%2C_Henning_von_Tresckow.jpg",
  },
  // 1937 - Guernica
  {
    year: 1937,
    ...
    category: "military",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Guernica_%28_Picasso%29.jpg/800px-Guernica_%28_Picasso%29.jpg",
  },
  // 1938 - Anschluss
  {
    year: 1938,
    ...
    category: "political",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Bundesarchiv_Bild_183-19370-0003%2C_Österreich%2C_Einzug_deutscher_Soldaten.jpg/800px-Bundesarchiv_Bild_183-19370-0003%2C_Österreich%2C_Einzug_deutscher_Soldaten.jpg",
  },
  ...
  // 1939 - Kristallnacht
  {
    ...
    category: "political",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/Bundesarchiv_Bild_141-106%2C_Berlin%2C_in-brand_gesteckte_Synagoge.jpg/800px-Bundesarchiv_Bild_141-106%2C_Berlin%2C_in-brand_gesteckte_Synagoge.jpg",
  },
  ...
  // 1940 - Winter War
  {
    ...
    category: "military",
    side: "ussr",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Winter_War_soldier_in_snow.jpg/800px-Winter_War_soldier_in_snow.jpg",
  },
  // 1940 - Blitzkrieg Denmark/Norway
  {
    ...
    category: "military",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Bundesarchiv_Bild_101I-187-0796-24%2C_Norwegen%2C_Fallschirmjäger.jpg/800px-Bundesarchiv_Bild_101I-187-0796-24%2C_Norwegen%2C_Fallschirmjäger.jpg",
  },
  // 1940 - France Invasion
  {
    ...
    category: "military",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Battle_of_France_1940.png/800px-Battle_of_France_1940.png",
  },
  // 1940 - Dunkirk
  {
    year: 1940,
    ...
    category: "military",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Dunkirk_evacuation.jpg/800px-Dunkirk_evacuation.jpg",
  },
  // 1940 - Battle of Britain
  {
    ...
    category: "military",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Spitfire_1940.jpg/800px-Spitfire_1940.jpg",
  },
  // 1940 - Vichy France
  {
    year: 1940,
    ...
    category: "political",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Marshall_Petain_1940.jpg/800px-Marshall_Petain_1940.jpg",
  },
  // 1941 - Operation Barbarossa
  {
    ...
    category: "military",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Operation_Barbarossa.png/800px-Operation_Barbarossa.png",
  },
  // 1941 - Pearl Harbor
  {
    year: 1941,
    ...
    category: "military",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Pearl_Harbor_Navy_Yard.jpg/800px-Pearl_Harbor_Navy_Yard.jpg",
  },
  // 1942 - Battle of Midway
  {
    ...
    category: "military",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Battle_of_Midway.jpg/800px-Battle_of_Midway.jpg",
  },
  // 1942 - El Alamein
  {
    year: 1942,
    ...
    category: "military",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Bundesarchiv_Bild_101I-721-0043-23%2C_Nordafrika%2C_Panzer_III.jpg/800px-Bundesarchiv_Bild_101I-721-0043-23%2C_Nordafrika%2C_Panzer_III.jpg",
  },
  // 1942 - Operation Torch
  {
    ...
    category: "military",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Operation_Torch.jpg/800px-Operation_Torch.jpg",
  },
  // 1943 - Stalingrad
  {
    year: 1943,
    ...
    category: "military",
    side: "ussr",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Stalingrad_German_surrender.jpg/800px-Stalingrad_German_surrender.jpg",
  },
  // 1943 - Operation Husky
  {
    ...
    category: "military",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Allied_invasion_of_Sicily.jpg/800px-Allied_invasion_of_Sicily.jpg",
  },
  // 1943 - Battle of Kursk
  {
    ...
    category: "military",
    side: "ussr",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Kursk_Bitva.png/800px-Kursk_Bitva.png",
  },
  ...
  // 1944 - Operation Market Garden
  {
    ...
    category: "military",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Market_Garden.jpg/800px-Market_Garden.jpg",
  },
  // 1944 - Battle of the Bulge
  {
    ...
    category: "military",
    side: "axis",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Battle_of_the_Bulge.jpg/800px-Battle_of_the_Bulge.jpg",
  },
  // 1945 - Yalta Conference
  {
    ...
    category: "political",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Yalta_Conference_1945.jpg/800px-Yalta_Conference_1945.jpg",
  },
  // 1945 - Iwo Jima
  {
    year: 1945,
    ...
    category: "military",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Iwo_Jima_flag-raising_1.jpg/800px-Iwo_Jima_flag-raising_1.jpg",
  },
  // 1945 - V-E Day
  {
    year: 1945,
    ...
    category: "political",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/VE_Day_Crowd_2.jpg/800px-VE_Day_Crowd_2.jpg",
  },
  // 1945 - Okinawa
  {
    year: 1945,
    ...
    category: "military",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Battle_of_Okinawa.jpg/800px-Battle_of_Okinawa.jpg",
  },
  // 1945 - Potsdam Conference
  {
    ...
    category: "political",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Potsdam_Conference.jpg/800px-Potsdam_Conference.jpg",
  },
  // 1945 - Hiroshima & Nagasaki
  {
    ...
    category: "military",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Mushroom_Cloud_over_Nagasaki_from_Kawasaki.jpg/800px-Mushroom_Cloud_over_Nagasaki_from_Kawasaki.jpg",
  },
  // 1945 - V-J Day
  {
    year: 1945,
    ...
    category: "political",
    side: "allied",
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/USS_Missouri_BB-63_surrender.jpg/800px-USS_Missouri_BB-63_surrender.jpg",
  },
];
...
const getCategoryColor = (category: string, side: string) => {
  ...
  return "var(--gold-amber)";
};

const getCategoryIcon = (category: string) => {
  switch (category) {
    case "military": return SwordsIcon;
    case "political": return BuildingIcon;
    case "economic": return MoneyIcon;
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ marginTop: "2rem" }}>
            <p style={{ color: "var(--gold-amber)", fontSize: "0.9rem", letterSpacing: "0.2em" }}>
              1922 - 1945
            </p>
          </div>
        </div>
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.5rem" }}>
                    <div style={{
                      ...
                      <IconComponent size={18} color={getCategoryColor(event.category, event.side)} />
                    </div>
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            ...
            { year: "1933-1939", label: "Road to War", color: "var(--gold-amber)" },
