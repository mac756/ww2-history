...
import { DocumentIcon, BuildingIcon, GlobeIcon, BookIcon, ArrowRight } from "@/components/Icons";
      ...
      >
        <div 
          style={{
            ...
            right: 0,
            bottom: 0,
            backgroundImage: "url('https://images.unsplash.com/photo-1461360370896-922624d12a74?w=1920&q=80')",
      ...
      >
        ...
        >
          <div style={{
            ...
            <BookIcon size={24} color="var(--gold-amber)" />
          </div>
          Books & Monographs
        </h2>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          >
            <div style={{
              ...
              <DocumentIcon size={24} color="var(--gold-amber)" />
            </div>
      ...
      >
        ...
        >
          <div style={{
            ...
            <BuildingIcon size={24} color="var(--gold-amber)" />
          </div>
          Archives & Museums
        </h2>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          >
            <div style={{
              ...
              <GlobeIcon size={24} color="var(--gold-amber)" />
            </div>
            Academic Journals
          </h2>
